				...
				<tbody>
					...
					<tr class="dot_line">
						...
						<td>
							...
							<p>지번 주소:<br> 
							<input type="text" id="roadAddress" name="roadAddress" size="50" value="${orderer.roadAddress }" /><br><br> 도로명 주소: 
							<input type="text" id="jibunAddress" name="jibunAddress" size="50" value="${orderer.jibunAddress }" /><br><br> 나머지 주소: 
							<input type="text" id="namujiAddress" name="namujiAddress" size="50" value="${orderer.namujiAddress }" /></p> 
		...
		<table width=80% class="list_view" style="background: #ccffff">
			<tbody>
				...
				<tr cellpadding=40 align=center>
					...
					<td>
						<p id="p_final_totalPrice"><font size="15">${final_total_order_price }원</font></p> 
		...
		<div class="detail_table">
			<table>
				<tbody>
					<tr>
						<td>
					   		<input type="radio" id="pay_method" name="pay_method" value="신용카드결제">신용카드결제 &nbsp;&nbsp;&nbsp;
					...
					<table>
						<tbody align=left>
							...
							<tr>
								...
								<td align=left>
									<p id="p_pay_method">카드결제</p>
								</td>
							</tr>
							<tr>
								<td width=200px>카드번호:</td>
								<td align=left><input id="cardNo" name="cardNo" type="text" value="" maxlength="20" placeholder="1111222233334444"/></td>
							</tr>
							<tr>
								<td width=200px>유효기간(월):</td>
								<td align=left><input id="expireMonth" name="expireMonth" type="text" value="" maxlength="2" placeholder="10"/>
								</td>
							</tr>
							<tr>
								<td width=200px>유효기간(년):</td>
								<td align=left><input id="expireYear" name="expireYear" type="text" value="" maxlength="2" placeholder="22"/>
								</td>
							</tr>
							<tr>
								<td width=200px>생년월일:</td>
								<td align=left><input id="birthday" name="birthday" type="text" value="" maxlength="6" placeholder="901020"/></td>
							</tr>
							<tr>
								<td width=200px>비밀번호2자리</td>
								<td align=left><input id="cardPw" name="cardPw" type="text" value="" maxlength="2"/></td>
							</tr>
							<tr>
								<td colspan=2 align=center>
								<input name="btn_process_pay_order" type="button" onClick="fn_process_pay_order()" value="최종결제하기"></td>
								<td colspan=2 align=center>
								<input name="btn_process_pay_order" type="button" onClick="fn_process_pay_order()" value="카카오결제하기"></td>
							</tr>
						</tbody>
					</table>
				</div>
...
<script>
    function m_Completepayment(FormOrJson, closeEvent) {
        ...
        if (frm.res_cd.value == "0000") {
        	...
        	console.log(frm);
        	frm.method="post";
        	frm.action="${contextPath}/order/payToOrderGoodsKakao.do";
        	frm.submit();
        } else {
        	alert("인증실패");
        	console.log(frm);
