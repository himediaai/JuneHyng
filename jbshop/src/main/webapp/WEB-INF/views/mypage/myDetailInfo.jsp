			...
			<table>
				<tbody>
					<tr class="dot_line">
						...
						<td><input name="member_id" type="text" size="20" value="${memberInfo.member_id }" disabled /></td>
					</tr>
					<tr class="dot_line">
					...
					<tr class="dot_line">
						...
						<td><input type="text" name="email1" size=10 value="${memberInfo.email1 }" /> @ 
					...
					<tr class="dot_line">
						...
						<td><input type="text" id="zipcode" name="zipcode" size=5 value="${memberInfo.zipcode }"> 
							...
							<p>
								...
								나머지 주소: 
								<input type="text" name="namujiAddress" size="50" value="${memberInfo.namujiAddress }" />
							</p>
						</td>
