...
<script>
	...
	//이메일 도메인주소 선택하기 START
	$(function(){
      	//직접입력 인풋박스 기존에는 숨어있다가
		$("#str_email02").hide();
		$("#selectEmail").change(function() {
        //직접입력을 누를 때 나타남
		if($("#selectEmail").val() == "non"){
			$("#str_email02").show();
		}else{
			$("#str_email02").hide();
		}
				...
				<tbody>
					...
					<tr class="dot_line">
						...
						<td>
							...
							<input size="10px" type="text" name="email2" id="str_email02"/> 
							<select name="email2" title="직접입력" id="selectEmail" >
					...
					<tr class="dot_line">
						...
						<td>
							...
							<a href="javascript:execDaumPostcode()">우편번호검색</a><br><p>지번 주소:<br>
							<input type="text" id="roadAddress" name="roadAddress" size="50"><br><br> 도로명 주소: 
							<input type="text" id="jibunAddress" name="jibunAddress" size="50"><br><br> 나머지 주소: 
